    ...
    public partial class SeedingDataForDifficultiesandRegions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("2f9fbbef-f1db-47de-80bd-669749f5db32"), "Medium" },
                    { new Guid("785ca6f2-08c3-48f0-b317-ecfd3d037cc7"), "Hard" },
                    { new Guid("ca289952-e102-4a2e-a43e-d680e4535e82"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("2f9fbbef-f1db-47de-80bd-669749f5db32"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("785ca6f2-08c3-48f0-b317-ecfd3d037cc7"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ca289952-e102-4a2e-a43e-d680e4535e82"));
